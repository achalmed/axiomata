...
\title{Proporcionalidad en ciencias comunicación}


\shorttitle{Proporcionalidad en ciencias comunicación}
...
\hypersetup{
  pdftitle={Proporcionalidad en ciencias comunicaci\'{o}n},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Proporcionalidad en ciencias comunicación}
...
\noindent \emph{Nota.} Elaboración~propia
...
\CommentTok{\# Datos}
\NormalTok{x }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{6}\NormalTok{, }\DecValTok{8}\NormalTok{, }\DecValTok{10}\NormalTok{])  }\CommentTok{\# Publicaciones en redes sociales}
\NormalTok{y }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{20}\NormalTok{, }\DecValTok{40}\NormalTok{, }\DecValTok{60}\NormalTok{, }\DecValTok{80}\NormalTok{, }\DecValTok{100}\NormalTok{])  }\CommentTok{\# Interacciones (en cientos)}

\CommentTok{\# Gráfica}
\NormalTok{plt.figure(figsize}\OperatorTok{=}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{4}\NormalTok{))}
\NormalTok{plt.plot(x, y, }\StringTok{\textquotesingle{}o{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Datos observados\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.plot(x, }\DecValTok{10}\OperatorTok{*}\NormalTok{x, }\StringTok{\textquotesingle{}{-}{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}gray\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Línea de proporcionalidad ($y = 10x$)\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.xlabel(}\StringTok{\textquotesingle{}Publicaciones en redes sociales ($x$, en publicaciones)\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.ylabel(}\StringTok{\textquotesingle{}Interacciones ($y$, en cientos)\textquotesingle{}}\NormalTok{)}
\CommentTok{\# plt.title(\textquotesingle{}Relación entre Publicaciones e Interacciones\textquotesingle{})}
\CommentTok{\# plt.grid(True)}
\CommentTok{\# plt.legend()}

\CommentTok{\# Ocultar bordes (spines) superiores y derechos}
...
\CommentTok{\# Datos}
\NormalTok{x }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{8}\NormalTok{])  }\CommentTok{\# Tiempo de verificación (en horas)}
\NormalTok{y }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{40}\NormalTok{, }\DecValTok{20}\NormalTok{, }\DecValTok{10}\NormalTok{, }\DecValTok{5}\NormalTok{])  }\CommentTok{\# Errores en publicaciones (en cantidad)}

\CommentTok{\# Gráfica}
\NormalTok{plt.figure(figsize}\OperatorTok{=}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{4}\NormalTok{))}
\NormalTok{plt.plot(x, y, }\StringTok{\textquotesingle{}*{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Datos observados\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.plot(x, }\DecValTok{40}\OperatorTok{/}\NormalTok{x, }\StringTok{\textquotesingle{}{-}{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}gray\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Curva de proporcionalidad ($y = 40/x$)\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.xlabel(}\StringTok{\textquotesingle{}Tiempo de verificación ($x$, en horas)\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.ylabel(}\StringTok{\textquotesingle{}Errores en publicaciones ($y$, en cantidad)\textquotesingle{}}\NormalTok{)}
\CommentTok{\# plt.title(\textquotesingle{}Relación entre Verificación y Errores\textquotesingle{})}
\CommentTok{\# plt.grid(True)}
\CommentTok{\# plt.legend()}
...
\CommentTok{\# Datos}
\NormalTok{proyectos }\OperatorTok{=}\NormalTok{ [}\StringTok{\textquotesingle{}Proyecto 1\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Proyecto 2\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Proyecto 3\textquotesingle{}}\NormalTok{]}
\NormalTok{proporciones }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{1}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{4}\NormalTok{])}
\NormalTok{montos }\OperatorTok{=}\NormalTok{ proporciones }\OperatorTok{*} \DecValTok{1500}  \CommentTok{\# k = 1500}

\CommentTok{\# Gráfica}
\NormalTok{plt.figure(figsize}\OperatorTok{=}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{4}\NormalTok{))}
\NormalTok{plt.bar(proyectos, montos, color}\OperatorTok{=}\StringTok{\textquotesingle{}skyblue\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Monto asignado\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.xlabel(}\StringTok{\textquotesingle{}Proyectos\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.ylabel(}\StringTok{\textquotesingle{}Monto asignado (S/)\textquotesingle{}}\NormalTok{)}
\CommentTok{\# plt.title(\textquotesingle{}Reparto directo del presupuesto\textquotesingle{})}
\CommentTok{\# plt.grid(True, axis=\textquotesingle{}y\textquotesingle{})}
\CommentTok{\# plt.legend()}
...
\CommentTok{\# Datos}
\NormalTok{equipos }\OperatorTok{=}\NormalTok{ [}\StringTok{\textquotesingle{}Equipo 1\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Equipo 2\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Equipo 3\textquotesingle{}}\NormalTok{]}
\NormalTok{tiempos }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{])}
\NormalTok{k }\OperatorTok{=} \FloatTok{34285.71}
\NormalTok{montos }\OperatorTok{=}\NormalTok{ k }\OperatorTok{/}\NormalTok{ tiempos  }\CommentTok{\# k dividido por los tiempos}

\CommentTok{\# Gráfica}
\NormalTok{plt.figure(figsize}\OperatorTok{=}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{4}\NormalTok{))}
\NormalTok{plt.bar(equipos, montos, color}\OperatorTok{=}\StringTok{\textquotesingle{}lightcoral\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Monto asignado\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.xlabel(}\StringTok{\textquotesingle{}Equipos\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.ylabel(}\StringTok{\textquotesingle{}Monto asignado (S/)\textquotesingle{}}\NormalTok{)}
\CommentTok{\# plt.title(\textquotesingle{}Reparto inverso del fondo\textquotesingle{})}
\CommentTok{\# plt.grid(True, axis=\textquotesingle{}y\textquotesingle{})}
\CommentTok{\# plt.legend()}
...
\CommentTok{\# Datos}
\NormalTok{articulos }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{2}\NormalTok{, }\DecValTok{5}\NormalTok{])}
\NormalTok{tiempo }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{4}\NormalTok{, }\DecValTok{10}\NormalTok{])}

\CommentTok{\# Gráfica}
\NormalTok{plt.figure(figsize}\OperatorTok{=}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{4}\NormalTok{))}
\NormalTok{plt.plot(articulos, tiempo, }\StringTok{\textquotesingle{}o{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Datos observados\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.plot(articulos, }\DecValTok{2}\OperatorTok{*}\NormalTok{articulos, }\StringTok{\textquotesingle{}{-}{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}gray\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Proporción ($y = 2x$)\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.xlabel(}\StringTok{\textquotesingle{}Número de artículos\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.ylabel(}\StringTok{\textquotesingle{}Tiempo (horas)\textquotesingle{}}\NormalTok{)}
\CommentTok{\# plt.title(\textquotesingle{}Regla de tres simple directa\textquotesingle{})}
\CommentTok{\# plt.grid(True)}
\CommentTok{\# plt.legend()}
...
\CommentTok{\# Datos}
\NormalTok{maquinas }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{4}\NormalTok{, }\DecValTok{8}\NormalTok{])}
\NormalTok{tiempo }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{12}\NormalTok{, }\FloatTok{2.67}\NormalTok{])}

\CommentTok{\# Gráfica}
\NormalTok{plt.figure(figsize}\OperatorTok{=}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{4}\NormalTok{))}
\NormalTok{plt.plot(maquinas, tiempo, }\StringTok{\textquotesingle{}o{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Datos observados\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.plot(maquinas, }\DecValTok{32}\OperatorTok{/}\NormalTok{maquinas, }\StringTok{\textquotesingle{}{-}{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}gray\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Proporción ($y = 32/x$)\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.xlabel(}\StringTok{\textquotesingle{}Número de máquinas\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.ylabel(}\StringTok{\textquotesingle{}Tiempo (horas)\textquotesingle{}}\NormalTok{)}
\CommentTok{\# plt.title(\textquotesingle{}Regla de tres simple inversa\textquotesingle{})}
\CommentTok{\# plt.grid(True)}
\CommentTok{\# plt.legend()}
...
\CommentTok{\# Datos}
\NormalTok{videos }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{3}\NormalTok{, }\DecValTok{7}\NormalTok{])}
\NormalTok{tiempo }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{9}\NormalTok{, }\DecValTok{21}\NormalTok{])}

\CommentTok{\# Gráfica}
\NormalTok{plt.figure(figsize}\OperatorTok{=}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{4}\NormalTok{))}
\NormalTok{plt.plot(videos, tiempo, }\StringTok{\textquotesingle{}o{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Datos observados\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.plot(videos, }\DecValTok{3}\OperatorTok{*}\NormalTok{videos, }\StringTok{\textquotesingle{}{-}{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}gray\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Proporción ($y = 3x$)\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.xlabel(}\StringTok{\textquotesingle{}Número de videos\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.ylabel(}\StringTok{\textquotesingle{}Tiempo (horas)\textquotesingle{}}\NormalTok{)}
\CommentTok{\# plt.grid(True)}
...
\CommentTok{\# Datos}
\NormalTok{disenadores }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{5}\NormalTok{, }\DecValTok{10}\NormalTok{])}
\NormalTok{tiempo }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{10}\NormalTok{, }\DecValTok{5}\NormalTok{])}

\CommentTok{\# Gráfica}
\NormalTok{plt.figure(figsize}\OperatorTok{=}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{4}\NormalTok{))}
\NormalTok{plt.plot(disenadores, tiempo, }\StringTok{\textquotesingle{}o{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}blue\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Datos observados\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.plot(disenadores, }\DecValTok{50}\OperatorTok{/}\NormalTok{disenadores, }\StringTok{\textquotesingle{}{-}{-}\textquotesingle{}}\NormalTok{, color}\OperatorTok{=}\StringTok{\textquotesingle{}gray\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Proporción ($y = 50/x$)\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.xlabel(}\StringTok{\textquotesingle{}Número de diseñadores\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.ylabel(}\StringTok{\textquotesingle{}Tiempo (días)\textquotesingle{}}\NormalTok{)}
\CommentTok{\# plt.grid(True)}
\NormalTok{plt.legend()}
\NormalTok{ax }\OperatorTok{=}\NormalTok{ plt.gca()}
\NormalTok{ax.spines[}\StringTok{\textquotesingle{}top\textquotesingle{}}\NormalTok{].set\_visible(}\VariableTok{False}\NormalTok{)}
...
\CommentTok{\# Datos}
\NormalTok{campanas }\OperatorTok{=}\NormalTok{ [}\StringTok{\textquotesingle{}Campaña 1\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Campaña 2\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Campaña 3\textquotesingle{}}\NormalTok{]}
\NormalTok{proporciones }\OperatorTok{=}\NormalTok{ np.array([}\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{5}\NormalTok{])}
\NormalTok{montos }\OperatorTok{=}\NormalTok{ proporciones }\OperatorTok{*} \DecValTok{1500}

\CommentTok{\# Gráfica}
\NormalTok{plt.figure(figsize}\OperatorTok{=}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{4}\NormalTok{))}
\NormalTok{plt.bar(campanas, montos, color}\OperatorTok{=}\StringTok{\textquotesingle{}skyblue\textquotesingle{}}\NormalTok{, label}\OperatorTok{=}\StringTok{\textquotesingle{}Monto asignado\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.xlabel(}\StringTok{\textquotesingle{}Campañas\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.ylabel(}\StringTok{\textquotesingle{}Monto asignado (S/)\textquotesingle{}}\NormalTok{)}
\CommentTok{\# plt.grid(True, axis=\textquotesingle{}y\textquotesingle{})}
\NormalTok{plt.legend()}
\NormalTok{ax }\OperatorTok{=}\NormalTok{ plt.gca()}
